(function(p, j) {
	...
	c.fn.extend({
		...
		toggleClass: function(a, b) {
			...
			return this.each(function() {
				if (e === "string")
					for (var f, l = 0, k = c(this), s = b, m = a.split(sa); f = m[l++];) {
						s = g ? s : !k.hasClass(f);
		...
		trigger: function(a, b, e, g) {
			...
			try {
				if (!(e && e.nodeName && c.noData[e.nodeName.toLowerCase()]))
					if (e["on" + f] && e["on" + f].apply(e, b) === false) a.result = false
			} catch (l) {}
...
jQuery.extend(jQuery.easing, {
	...
	easeInOutElastic: function(p, j, u, t, o) {
		...
		if (G < Math.abs(t)) {
			G = t;
			p = z / 4
		} else p = z / (2 * Math.PI) * Math.asin(t / G); if (j < 1) return -0.5 * G * Math.pow(2, 10 * (j -= 1)) * Math.sin((j * o - p) * 2 * Math.PI / z) + u;
			...
			if (p.browser.msie && p.browser.version.substr(0,
				...
				V.each(function() {
					...
					if (typeof o.attribute == "function") {
						...
						o.attribute + "=" + p(this).attr(o.attribute) + "]"); if (K.length) o.useScaling ? R.push({
						element: p(this),
						animation: {
